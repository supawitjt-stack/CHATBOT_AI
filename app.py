        ...
        with st.chat_message("model", avatar="🤖"):
            ...
            try:
                ...
                if kb_content:
                    ...
                    2. หากคำตอบไม่มีระบุอยู่ใน "เนื้อหาที่กำหนดให้" ให้ตอบกลับทันทีว่า "ขออภัยครับ ข้อมูลส่วนนี้น้อง C ยังไม่ได้เรียนรู้มาเลยครับ" (ห้ามพยายามอธิบายเพิ่มหรือแต่งเติมเอง)
                    ...
                    answer = "ขออภัยครับ ข้อมูลส่วนนี้น้อง C ยังไม่ได้เรียนรู้มาเลยครับ "
                # แสดงผล
